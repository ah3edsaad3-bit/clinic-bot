...
def cleaner_daemon():
    while True:
        ...
        for uid in list(SESSIONS.keys()):
            if now - SESSIONS[uid]["last_message_time"] > 21600:
                del SESSIONS[uid]
        time.sleep(21600)
...
نموذج الرد المقترح (جواب السؤال فقط من 2 الى 6 كلمات ) 
...
سياسة الإقناع:  واربط السعر بـ (المواد الألمانية + الضمان الحقيقي). حسسه إنه ماخذ صفقة ممتازة.
 الاختصار: جوابك سطر واحد فقط بدون اي مبالغة
